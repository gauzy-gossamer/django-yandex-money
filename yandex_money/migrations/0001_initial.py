    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_id', models.PositiveIntegerField(default=122236, verbose_name='ID магазина')),
                ('scid', models.PositiveIntegerField(default=91749, verbose_name='Номер витрины')),
                ...
                ('success_url', models.URLField(default='https://www.taeping.ru/payments/success/', verbose_name='URL успешной оплаты')),
                ('fail_url', models.URLField(default='https://www.taeping.ru/payments/fail/', verbose_name='URL неуспешной оплаты')),
